...
import IAutheticatedUser from "../../types/response/authencated-user";

const ERROR_OCCURED: IError = {
...
class RequestHandler {
    ...
    getWithAuth = (path: string, callback: (arg0: { params: any; query: any; user: IAutheticatedUser; }, arg1: (code: any, data: any) => void) => any) => {
     ...
     postWithBodyAndAuth = (path: string, callback: (arg0: { query: any, params: any; body: any; user: IAutheticatedUser; }, arg1: (code: any, data: any) => void) => any) => {
     ...
     putWithBodyAndAuth = (path: string, callback: (arg0: { query: any, params: any; body: any; user: IAutheticatedUser; }, arg1: (code: any, data: any) => void) => any) => {
    ...
    deleteWithAuth = (path: string, callback: (arg0: { params: any; body: any; user: IAutheticatedUser; }, arg1: (code: any, data: any) => void ) => any) => {
