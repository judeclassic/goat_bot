...
exports.TradtionalChineseMessageEarnTemplate = exports.TraditionalChineseMessageTemplete = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
class TraditionalChineseMessageTemplete {
}
_a = TraditionalChineseMessageTemplete;
TraditionalChineseMessageTemplete.decryptToken = (data) => {
    return jsonwebtoken_1.default.verify(data, process.env.SECRET_ENCRYPTION_KEY);
};
TraditionalChineseMessageTemplete.welcome = () => ("══════[ 🐐 GoatBot 🐐 ]══════\n" +
...
TraditionalChineseMessageTemplete.defaultMessage = (message) => ("══════[ 🐐 GoatBot 🐐 ]══════\n" +
    ` ${message}\n` +
    "_______________________________________________\n");
TraditionalChineseMessageTemplete.generateWalletEntities = (message, wallets, isTitled = true) => {
    let offset = 0;
    const entities = [];
...
TraditionalChineseMessageTemplete.generateExportWalletEntities = ({ wallets }) => {
    let offset = 0;
    const entities = [];
    const header = "══════[ 🐐 GoatBot 🐐 ]══════\n\n" +
        "🐐 GoatBot | Website\n" +
...
TraditionalChineseMessageTemplete.generateWalletBalanceEntities = ({ message = "使用 GOATBOT 提升您的加密貨幣交易——所有 Telegram 機器人中最出色的", balances }) => {
    let offset = 0;
    const entities = [];
    const header = "══════[ 🐐 GoatBot 🐐 ]══════\n\n" +
        "🐐 GoatBot | 網站 | 教學\n" +
...
TraditionalChineseMessageTemplete.buyNotificationMessage = (user, data) => {
    let offset = 0;
    const entities = [];
    let text = "══════[ 🐐 GoatBot 🐐 ]══════\n\n";
    text += "address:  ";
...
exports.TraditionalChineseMessageTemplete = TraditionalChineseMessageTemplete;
class TradtionalChineseMessageEarnTemplate {
}
TradtionalChineseMessageEarnTemplate.generateReferalMessage = (user) => {
...
exports.TradtionalChineseMessageEarnTemplate = TradtionalChineseMessageEarnTemplate;
