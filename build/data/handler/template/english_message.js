...
exports.EnglishMessageEarnTemplate = exports.EnglishMessageTemplete = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
class EnglishMessageTemplete {
}
_a = EnglishMessageTemplete;
EnglishMessageTemplete.decryptToken = (data) => {
    return jsonwebtoken_1.default.verify(data, process.env.SECRET_ENCRYPTION_KEY);
};
EnglishMessageTemplete.welcome = () => ("══════[ 🐐 GoatBot 🐐 ]══════\n" +
...
EnglishMessageTemplete.defaultMessage = (message) => ("══════[ 🐐 GoatBot 🐐 ]══════\n" +
    ` ${message}\n` +
    "_______________________________________________\n");
EnglishMessageTemplete.generateWalletEntities = (message, wallets, isTitled = true) => {
    let offset = 0;
    const entities = [];
...
EnglishMessageTemplete.generateExportWalletEntities = ({ wallets }) => {
    let offset = 0;
    const entities = [];
    const header = "══════[ 🐐 GoatBot 🐐 ]══════\n\n" +
        "🐐 GoatBot | Website\n" +
...
EnglishMessageTemplete.generateWalletBalanceEntities = ({ message = "Elevate Your Crypto Trades with GOATBOT– Greatest Of All Telegram Bots", balances }) => {
    let offset = 0;
    const entities = [];
    const header = "══════[ 🐐 GoatBot 🐐 ]══════\n\n" +
...
EnglishMessageTemplete.buyNotificationMessage = (user, data) => {
    let offset = 0;
    const entities = [];
    let text = "══════[ 🐐 GoatBot 🐐 ]══════\n\n";
    text += "address:  ";
...
exports.EnglishMessageTemplete = EnglishMessageTemplete;
class EnglishMessageEarnTemplate {
}
EnglishMessageEarnTemplate.generateReferalMessage = (user) => {
...
exports.EnglishMessageEarnTemplate = EnglishMessageEarnTemplate;
